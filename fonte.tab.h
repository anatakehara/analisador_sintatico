...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    ABRE_COLCHETES = 273,          /* ABRE_COLCHETES  */
    FECHA_COLCHETES = 274,         /* FECHA_COLCHETES  */
    ASPAS_DUPLAS = 275,            /* ASPAS_DUPLAS  */
    ASPAS_SIMPLES = 276,           /* ASPAS_SIMPLES  */
    VIRGULA = 277,                 /* VIRGULA  */
    BARRA = 278,                   /* BARRA  */
    HASHTAG = 279,                 /* HASHTAG  */
    PVIRGULA = 280,                /* PVIRGULA  */
    PONTO = 281,                   /* PONTO  */
    ...
    WHILE = 291,                   /* WHILE  */
    FOR = 292,                     /* FOR  */
    DECLARACAO = 293,              /* DECLARACAO  */
    COMPARADORES = 294,            /* COMPARADORES  */
    CODIGO_AUX = 295,              /* CODIGO_AUX  */
    DO = 296                       /* DO  */
  };
